...
contract StrategyPassiveManagerSushi is StratManager {
    ...
    function _harvest() private {
        ...
        totalLocked0 = currentLock0; // fee0 + currentLock0;
        totalLocked1 = currentLock1; // fee1 + currentLock1;
    ...
    function moveTicks()
        external
        onlyCalmPeriods //  onlyRebalancers
    {
        _claimEarnings();
        _removeLiquidity();
        _setTicks();
    ...
    //         uint256 out0;
    //         if (lpToken0 != native)
    //             out0 = IBeefySwapper(unirouter).swap(
    //                 lpToken0,
    //                 native,
    //                 amountToSwap0
    //             );
    ...
    //         uint256 out1;
    //         if (lpToken1 != native)
    //             out1 = IBeefySwapper(unirouter).swap(
    //                 lpToken1,
    //                 native,
    //                 amountToSwap1
    //             );
    ...
    //     uint256 strategistFeeAmount = (nativeEarned * fees.strategist) /
    //         DIVISOR;
